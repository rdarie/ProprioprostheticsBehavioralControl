...
SM.add_state(wait_for_correct_button_timed_uncued(['extraGood', 'bad', 'wait_for_correct_button_timed_uncued'], SM, 'wait_for_correct_button_timed_uncued', logFile = thisLog))
SM.add_state(good(['good'], SM, 'extraGood', logFile = thisLog))
