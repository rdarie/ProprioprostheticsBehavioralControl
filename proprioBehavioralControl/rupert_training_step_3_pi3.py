...
parser.add_argument('--wrongTimeout', default = '3')
...
motor = ifaces.motorInterface(
    ...
    acceleration = 15, deceleration = 10, useEncoder = True,
    dummy=DEBUGGING)
...
SM.uncuedRewardDur = 1.5
SM.cuedJackpotRewardDur = 0.5
SM.uncuedJackpotRewardDur = 2.5
SM.jackpot = True
...
SM.add_state(turnPedalCompoundWithStim(['chooseNextTrial'], SM, 'turnPedalCompound',
    ...
    smallProba=0.5, cWProba=0.01, angleJitter=5e2, waitAtPeak=0.1))
#
SM.add_state(chooseReportDifficulty(['waitEasy', 'waitHard'], SM, 'chooseNextTrial',
    logFile = None, probaBins = [0, .2, 1]))
#
