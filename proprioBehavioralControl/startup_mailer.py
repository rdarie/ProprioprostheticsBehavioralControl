...
# Account Information
to = 'radu_darie@brown.edu' # Email to send to.
gmail_user = 'radusraspberrypi@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'raspberry314' # Gmail password.
